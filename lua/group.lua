...
util.keymap("", "<leader>fa", "<cmd>FloatermNew --width=0.8 --height=0.5 --position=bottom <CR>")
util.keymap("", "<leader>lg", "<cmd>FloatermNew --width=0.8 --height=0.6 --position=bottom lazygit<CR>")
